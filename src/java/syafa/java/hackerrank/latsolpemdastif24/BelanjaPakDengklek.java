...
public class BelanjaPakDengklek
{
    public static void main(String[] args)
    {
        ...
        (
            ...
            "Jumlah pajak",':',(0.1 * (firstProduct + secondProduct + thirdProduct)),
            "Jumlah diskon",':',(0.05 * (firstProduct + secondProduct + thirdProduct)),
            "Total harga yang harus dibayarkan",':',((firstProduct + secondProduct + thirdProduct) + (0.1 * (firstProduct + secondProduct + thirdProduct)) - (0.05 * (firstProduct + secondProduct + thirdProduct)))
        );
    }
}